...
export async function seedCampanhasEndomarketing() {
  const campaigns = [
    // NEWSLETTERS 2025
    { id: generateId(), title: 'Newsletter Janeiro 2025', type: 'comunicado', status: 'planejada',
      ...
      start_date: '2025-01-01', end_date: '2025-01-31', created_at: now() },
    { id: generateId(), title: 'Newsletter Fevereiro 2025', type: 'comunicado', status: 'planejada',
      description: 'Boletim informativo mensal com notícias, dicas e informações sobre saúde e bem-estar.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Newsletter'],
      start_date: '2025-02-01', end_date: '2025-02-28', created_at: now() },
    { id: generateId(), title: 'Newsletter Março 2025', type: 'comunicado', status: 'planejada',
      description: 'Boletim informativo mensal com notícias, dicas e informações sobre saúde e bem-estar.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Newsletter'],
      start_date: '2025-03-01', end_date: '2025-03-31', created_at: now() },
    { id: generateId(), title: 'Newsletter Abril 2025', type: 'comunicado', status: 'planejada',
      description: 'Boletim informativo mensal com notícias, dicas e informações sobre saúde e bem-estar.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Newsletter'],
      start_date: '2025-04-01', end_date: '2025-04-30', created_at: now() },
    { id: generateId(), title: 'Newsletter Maio 2025', type: 'comunicado', status: 'planejada',
      description: 'Boletim informativo mensal com notícias, dicas e informações sobre saúde e bem-estar.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Newsletter'],
      start_date: '2025-05-01', end_date: '2025-05-31', created_at: now() },
    ...
    // NEWSLETTERS 2026
    { id: generateId(), title: 'Newsletter Janeiro 2026', type: 'comunicado', status: 'planejada',
      description: 'Boletim informativo mensal com notícias, dicas e informações sobre saúde e bem-estar.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Newsletter'],
      start_date: '2026-01-01', end_date: '2026-01-31', created_at: now() },
    { id: generateId(), title: 'Newsletter Fevereiro 2026', type: 'comunicado', status: 'planejada',
      description: 'Boletim informativo mensal com notícias, dicas e informações sobre saúde e bem-estar.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Newsletter'],
      start_date: '2026-02-01', end_date: '2026-02-28', created_at: now() },
    { id: generateId(), title: 'Newsletter Março 2026', type: 'comunicado', status: 'planejada',
      description: 'Boletim informativo mensal com notícias, dicas e informações sobre saúde e bem-estar.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Newsletter'],
      start_date: '2026-03-01', end_date: '2026-03-31', created_at: now() },
    { id: generateId(), title: 'Newsletter Abril 2026', type: 'comunicado', status: 'planejada',
      description: 'Boletim informativo mensal com notícias, dicas e informações sobre saúde e bem-estar.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Newsletter'],
      start_date: '2026-04-01', end_date: '2026-04-30', created_at: now() },
    { id: generateId(), title: 'Newsletter Maio 2026', type: 'comunicado', status: 'planejada',
      description: 'Boletim informativo mensal com notícias, dicas e informações sobre saúde e bem-estar.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Newsletter'],
