...
export async function seedCampanhasEndomarketing() {
  const campaigns = [
    ...
    // JANEIRO
    { id: generateId(), title: 'Janeiro Branco — Saúde Mental', type: 'campanha', status: 'encerrada',
    ...
    { id: generateId(), title: 'Janeiro Roxo — Hanseníase', type: 'campanha', status: 'encerrada',
    ...
    // FEVEREIRO
    { id: generateId(), title: 'Fevereiro Laranja — Leucemia e Bullying', type: 'campanha', status: 'encerrada',
    ...
    { id: generateId(), title: 'Fevereiro Roxo — Fibromialgia, Lúpus e Alzheimer', type: 'campanha', status: 'encerrada',
    ...
    // MARÇO
    { id: generateId(), title: 'Março Lilás — Prevenção ao Câncer de Colo de Útero', type: 'campanha', status: 'encerrada',
    ...
    { id: generateId(), title: 'Março Azul-Marinho — Câncer Colorretal', type: 'campanha', status: 'encerrada',
      description: 'Prevenção no trabalho começa por você. Conscientização sobre prevenção de câncer colorretal.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Mural físico/digital','Reunião presencial'],
      start_date: '2026-03-01', end_date: '2026-03-31', created_at: now() },

    // ABRIL
    { id: generateId(), title: 'Abril Verde (SIPAT) — Saúde e Segurança no Trabalho', type: 'campanha', status: 'encerrada',
    ...
    { id: generateId(), title: 'Abril Azul — Autismo (TEA)', type: 'campanha', status: 'encerrada',
    ...
    { id: generateId(), title: 'Abril Laranja — Prevenção de Amputações', type: 'campanha', status: 'encerrada',
      description: 'Seus dedos valem ouro. Proteja-os. Conscientização sobre acidentes de trabalho.',
      target_audience: 'Toda a equipe', channels: ['E-mail','Mural físico/digital'],
      start_date: '2026-04-01', end_date: '2026-04-30', created_at: now() },

    // MAIO
    { id: generateId(), title: 'Maio Amarelo — Segurança no Trânsito', type: 'campanha', status: 'encerrada',
